use anyhow::Result;
use clap::Parser;
use parapet_api_core::{config::load_config_from_file, create_router, state};

#[derive(Parser)]
#[command(name = "parapet-api-core")]
#[command(about = "Parapet Core API - Lean MCP server for AI agents")]
struct Cli {
