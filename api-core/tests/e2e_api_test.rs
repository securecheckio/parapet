/// End-to-end correctness tests for parapet-api-core
/// Tests the complete HTTP endpoint request/response cycle
use axum::body::Body;
use axum::http::{Request, StatusCode};
use parapet_api_core::{create_router, state::AppState, state::Config};
...
async fn test_health_endpoint() {
    ...
    assert_eq!(json_response["service"], "parapet-api-core");
}
