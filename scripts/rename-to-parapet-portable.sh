...
replace_in_files "parapet-core" "parapet-core" "Cargo.toml"
replace_in_files "parapet-proxy" "parapet-proxy" "Cargo.toml"
replace_in_files "parapet-scanner" "parapet-scanner" "Cargo.toml"
replace_in_files "parapet-api" "parapet-api" "Cargo.toml"
replace_in_files "parapet-mcp" "parapet-mcp" "Cargo.toml"
replace_in_files "parapet-rpc-perf" "parapet-rpc-perf" "Cargo.toml"
replace_in_files "Parapet Team" "SecureCheck Team" "Cargo.toml"
replace_in_files "github.com/securecheck/parapet" "github.com/securecheckio/parapet" "Cargo.toml"
...
find . -type f -name "package.json" ! -path "*/node_modules/*" ! -path "*/.git/*" -exec sed -i \
    -e "s/@securecheck\/parapet/@securecheck\/parapet/g" \
    -e "s/parapet/parapet/g" \
    {} +
...
find . -type f -name "*.md" ! -path "*/.git/*" ! -path "*/target/*" ! -path "*/node_modules/*" -exec sed -i \
    ...
    -e "s/parapet/parapet/g" \
    -e "s/SolShield/Parapet/g" \
    -e "s|github.com/securecheckio/parapet|github.com/securecheckio/parapet|g" \
    -e "s|github.com/securecheck/parapet|github.com/securecheckio/parapet|g" \
    {} +
...
find . -type f \( -name "Dockerfile*" -o -name "docker-compose*.yml" -o -name ".dockerignore" \) \
    ! -path "*/.git/*" -exec sed -i "s/parapet/parapet/g" {} +
