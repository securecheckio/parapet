        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-400">
                <li><a href="https://github.com/securecheckio/sol-shield" target="_blank" rel="noopener noreferrer" className="hover:text-slate-200 transition-colors">Documentation</a></li>
              </ul>
            </div>
            <div>
