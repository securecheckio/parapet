...
impl InnerInstructionAnalyzer {
    ...
    pub fn with_default_config() -> Self {
        ...
        let default_paths = vec![
            "sol-shield/rpc-proxy/config/known-safe-programs.json",
...
impl TransactionAnalyzer for InnerInstructionAnalyzer {
    ...
    async fn analyze(&self, _tx: &Transaction) -> Result<HashMap<String, Value>> {
        ...
        result.insert("has_deep_cpis".to_string(), json!(false));
    ...
    async fn analyze_with_metadata(
        ...
        let has_deep_cpis = inner_programs.len() > 5;
        ...
        result.insert("has_deep_cpis".to_string(), json!(has_deep_cpis));
