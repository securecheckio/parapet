...
echo "Building Parapet MCP Server v$VERSION for all platforms..."
...
TARGETS=(
    "x86_64-unknown-linux-gnu:parapet-mcp:linux-x86_64"
    "x86_64-apple-darwin:parapet-mcp:macos-x86_64"
    "aarch64-apple-darwin:parapet-mcp:macos-arm64"
    "x86_64-pc-windows-msvc:parapet-mcp.exe:windows-x86_64"
)
...
for target_info in "${TARGETS[@]}"; do
    ...
    ARCHIVE_NAME="parapet-mcp-$platform_name-v$VERSION"
