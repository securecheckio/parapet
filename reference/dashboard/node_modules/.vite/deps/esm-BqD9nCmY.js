...
import { C as WalletNotConnectedError, D as WalletSignInError, E as WalletSendTransactionError, O as WalletSignMessageError, T as WalletPublicKeyError, _ as WalletConnectionError, a as SolanaSignTransaction, b as WalletError, c as BaseSignInMessageSignerWalletAdapter, d as BaseWalletAdapter, f as WalletReadyState, g as WalletConfigError, h as WalletAccountError, i as StandardConnect, k as WalletSignTransactionError, n as isWalletAdapterCompatibleStandardWallet, o as SolanaSignAndSendTransaction, r as StandardEvents, u as isVersionedTransaction$1, v as WalletDisconnectedError, w as WalletNotReadyError, y as WalletDisconnectionError } from "./esm-DttGDQVD.js";
import { j as PublicKey, mt as VersionedTransaction, nt as Transaction, p as Connection, pt as VersionedMessage } from "./index.browser.esm-EZ64b1BI.js";
import { t as require_react } from "./react.js";
import { t as require_browser } from "./browser-CgxjSkkI.js";
import { t as esm_default } from "./esm-D1a_n9Zi.js";
...
async function parseHelloRsp(payloadBuffer, associationPublicKey, ecdhPrivateKey) {
	const [associationPublicKeyBuffer, walletPublicKey] = await Promise.all([crypto.subtle.exportKey("raw", associationPublicKey), crypto.subtle.importKey("raw", payloadBuffer.slice(0, ENCODED_PUBLIC_KEY_LENGTH_BYTES), {
		name: "ECDH",
		namedCurve: "P-256"
	}, false, [])]);
...
var LocalSolanaMobileWalletAdapterWallet = class {
	...
	*/
	...
	#signMessage = async (...inputs) => {
		const { authToken, chain } = this.#assertIsAuthorized();
		const addresses = inputs.map(({ account }) => fromUint8Array$1(new Uint8Array(account.publicKey)));
	...
	#performSignIn = async (input) => {
		...
		try {
			...
			return {
				account: {
					...signedInAccount ?? { address: esm_default.encode(toUint8Array(signedInAddress)) },
...
//# sourceMappingURL=esm-BqD9nCmY.js.map