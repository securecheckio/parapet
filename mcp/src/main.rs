...
async fn main() -> Result<()> {
    ...
    log::info!("Starting Sol-Shield MCP Server");
...
fn handle_resource_read(uri: &str) -> Result<Value> {
    let content = match uri {
        "sol-shield://guide" => include_str!("../resources/guide.md"),
        "sol-shield://risk-scoring" => include_str!("../resources/risk-scoring.md"),
        "sol-shield://examples" => include_str!("../resources/examples.md"),
