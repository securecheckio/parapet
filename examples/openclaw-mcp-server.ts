#!/usr/bin/env node
/**
 * Parapet MCP Server for OpenClaw
 * 
 * Provides secure Solana transaction tools with Parapet protection
 ...
 *   - SOL_SHIELD_RPC_URL: Parapet RPC proxy URL (default: http://localhost:8899)
 *   - SOL_SHIELD_API_URL: Parapet API URL (default: http://localhost:3001)
 */
  ...
  tools: [
    {
      ...
      description: 'Simulate Solana transaction with Parapet security analysis',
      inputSchema: {
        type: 'object',
        properties: {
          transaction_base58: {
    ...
    },
    {
      ...
      description: 'Send Solana transaction with Parapet protection. Supports human-in-the-loop escalations for blocked transactions.',
      inputSchema: {
        type: 'object',
        properties: {
          transaction_base58: {
