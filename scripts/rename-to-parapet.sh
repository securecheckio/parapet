...
# This script performs bulk renaming operations for the Parapet → Parapet rebrand
...
fd -e toml 'Cargo.toml' -x sd 'parapet-core' 'parapet-core' {}
fd -e toml 'Cargo.toml' -x sd 'parapet-proxy' 'parapet-proxy' {}
fd -e toml 'Cargo.toml' -x sd 'parapet-scanner' 'parapet-scanner' {}
fd -e toml 'Cargo.toml' -x sd 'parapet-api' 'parapet-api' {}
fd -e toml 'Cargo.toml' -x sd 'parapet-mcp' 'parapet-mcp' {}
fd -e toml 'Cargo.toml' -x sd 'parapet-rpc-perf' 'parapet-rpc-perf' {}
fd -e toml 'Cargo.toml' -x sd 'Parapet Team' 'SecureCheck Team' {}
fd -e toml 'Cargo.toml' -x sd 'github.com/securecheck/parapet' 'github.com/securecheckio/parapet' {}
...
fd 'package.json' -x sd '@securecheck/parapet' '@securecheck/parapet' {}
fd 'package.json' -x sd 'parapet' 'parapet' {}
echo "✅ package.json files updated"
echo ""

# Phase 6: Update TypeScript/JavaScript code
echo "📝 Phase 6: Updating TypeScript/JavaScript code..."
fd -e ts -e js -x sd 'parapet' 'parapet' {}
...
fd -e rs -e ts -e js -x sd '// Parapet' '// Parapet' {}
fd -e rs -e ts -e js -x sd '/// Parapet' '/// Parapet' {}
...
fd -e md -e rs -e toml -e ts -e js -x sd 'github.com/securecheckio/parapet' 'github.com/securecheckio/parapet' {}
fd -e md -e rs -e toml -e ts -e js -x sd 'github.com/securecheck/parapet' 'github.com/securecheckio/parapet' {}
echo "✅ URLs updated"
echo ""

# Phase 10: Update config files
echo "⚙️  Phase 10: Updating config files..."
fd -e toml -e yaml -e yml -e env -x sd 'parapet' 'parapet' {}
fd -e toml -e yaml -e yml -e env -x sd 'Parapet' 'Parapet' {}
...
fd 'Dockerfile' -x sd 'parapet' 'parapet' {}
fd 'docker-compose.yml' -x sd 'parapet' 'parapet' {}
fd '.dockerignore' -x sd 'parapet' 'parapet' {}
...
fd -e json -e toml -p tests -x sd 'parapet' 'parapet' {}
